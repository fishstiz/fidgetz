...
public class AbstractListScreen extends FZScreen {
    ...
    protected void collectChildren(GuiComponentCollector collector) {
        FZLayouts.composer(this, FZLayouts.flexVertical(this).spacing(8).also(root -> {
        ...
        })).padded(0, 8, 0, 8).centered().clamped().arrange().visitWidgets(collector::renderableWidget);
    }
}
