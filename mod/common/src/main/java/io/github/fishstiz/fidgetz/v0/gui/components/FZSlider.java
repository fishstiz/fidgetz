...
public class FZSlider extends AbstractSliderButton implements FZComponent, FZContextMenu.Source {
    ...
    public record ClickEvent(FZSlider target, MouseButtonEvent buttonEvent) {
    }

    public record DragEvent(FZSlider target, MouseButtonEvent buttonEvent) {
    }

    public record ReleaseEvent(FZSlider target, MouseButtonEvent buttonEvent) {
    }
