...
public final class GuiGraphicsUtils {
    ...
    public static void addGuiElement(GuiGraphics graphics, GuiElementRenderState blitState) {
        GUI_GRAPHICS_SERVICE.addGuiElement(graphics, blitState);
    }

    public static @Nullable ScreenRectangle peekScissorStack(GuiGraphics graphics) {
