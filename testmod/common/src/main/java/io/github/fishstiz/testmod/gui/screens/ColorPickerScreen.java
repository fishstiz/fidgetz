        ...
        collector.addWidget(
                _ -> FZColorPicker.bind(
                        ...
                        colorRef.map(color -> FZColorPicker.builder()
                                ...
                                .swatch(TextColor.BLACK)
                                .swatch(TextColor.DARK_BLUE)
                                .swatch(TextColor.DARK_GREEN)
                                .swatch(TextColor.DARK_AQUA)
                                .swatch(TextColor.DARK_RED)
                                .swatch(TextColor.DARK_PURPLE)
                                .swatch(TextColor.GOLD)
                                .swatch(TextColor.GRAY)
                                .swatch(TextColor.DARK_GRAY)
                                .swatch(TextColor.BLUE)
                                .swatch(TextColor.GREEN)
                                .swatch(TextColor.AQUA)
                                .swatch(TextColor.RED)
                                .swatch(TextColor.LIGHT_PURPLE)
                                .swatch(TextColor.YELLOW)
                                .swatch(TextColor.WHITE)
                                .onChange(e -> colorRef.set(e.color()))
                                .toProps()
                        )
                ),
