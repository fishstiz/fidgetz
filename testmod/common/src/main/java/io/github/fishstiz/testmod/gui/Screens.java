...
public class Screens {
    public static void addScreenButtons(FZFlexLayout layout) {
        ...
        layout.child(Button.builder(Component.literal("Test Screen"), ignored -> minecraft.setScreen(new TestmodScreen())).build());
        layout.child(Button.builder(Component.literal("Flex Screen"), ignored -> minecraft.setScreen(new FlexScreen())).build());
        layout.child(Button.builder(Component.literal("FZ Screen"), ignored -> minecraft.setScreen(new FZTestScreen())).build());
        layout.child(Button.builder(Component.literal("Wrap Screen"), ignored -> minecraft.setScreen(new FlexWrapScreen())).build());
