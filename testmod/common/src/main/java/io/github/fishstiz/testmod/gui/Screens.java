...
public class Screens {
    public static void addScreenButtons(FZFlexLayout layout) {
        ...
        layout.child(Button.builder(Component.literal("GridLayout"), _ -> minecraft.setScreen(new GridScreen())).build());
        layout.child(Button.builder(Component.literal("ColorPicker"), _ -> minecraft.setScreen(new ColorPickerScreen())).build());
    }
}
